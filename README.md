...
## 🖥️ How to Download and Install agenthub
...
- Download the new `.exe` installer file.
- Run the installer again to update your software.
...
- **Settings and Configurations:**  
  In the folder `C:\Users\[YourName]\AppData\Local\agenthub\`

- **Install Folder:**  
  Usually `C:\Program Files\agenthub\`
